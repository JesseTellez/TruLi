...
- (IBAction)Signup:(id)sender {
    ...
    if ([username length] == 0 || [password length] == 0 || [email length] == 0) {
        //create the alert
        UIAlertView *alertview = [[UIAlertView alloc]initWithTitle:@"Oops!" message:@"Make sure you enter a username, password, and email adress!" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
        //show the alert
        [alertview show];
    }
    else {
